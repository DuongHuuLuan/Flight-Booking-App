              ...
              children: [
                ...
                BottomPaymentBar(
                  label: state.selectedSeats.isEmpty
                      ? "No seat selected"
                      : "${state.selectedSeats.length} of ${cubit.totalPassengers} seats selected",
                  buttonText: "Continue",
                  price: state.totalPrice,
                  priceStyle: AppTextStyles.heading3.copyWith(
                    color: AppColor.black,
                  ),
                  onPressed: state.selectedSeats.length != cubit.totalPassengers
                      ? null
                      : () async {
                          ...
                          if (bookingId != null && context.mounted) {
                            context.push(
                              ...
                              extra: cubit.buildNavigationPayload(bookingId),
                            );
                          }
                        },
                ),
