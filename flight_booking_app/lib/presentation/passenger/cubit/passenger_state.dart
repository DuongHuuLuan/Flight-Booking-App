  ...
  PassengerFormData copyWithField(String field, dynamic value) {
    return switch (field) {
      ...
      'name' => PassengerFormData(
        seatLabel: seatLabel, ageGroup: ageGroup,
        name: value as String, mobilePhone: mobilePhone,
        dateOfBirth: dateOfBirth, passportNumber: passportNumber,
        nationality: nationality, address: address,
        email: email, idNumber: idNumber, baggageLevel: baggageLevel,
      ),
      'mobilePhone' => PassengerFormData(
        seatLabel: seatLabel, ageGroup: ageGroup,
        name: name, mobilePhone: value as String,
        dateOfBirth: dateOfBirth, passportNumber: passportNumber,
        nationality: nationality, address: address,
        email: email, idNumber: idNumber, baggageLevel: baggageLevel,
      ),
      'dateOfBirth' => PassengerFormData(
        seatLabel: seatLabel, ageGroup: ageGroup,
        name: name, mobilePhone: mobilePhone,
        dateOfBirth: value as DateTime?, passportNumber: passportNumber,
        nationality: nationality, address: address,
        email: email, idNumber: idNumber, baggageLevel: baggageLevel,
      ),
      'passportNumber' => PassengerFormData(
        seatLabel: seatLabel, ageGroup: ageGroup,
        name: name, mobilePhone: mobilePhone,
        dateOfBirth: dateOfBirth, passportNumber: value as String,
        nationality: nationality, address: address,
        email: email, idNumber: idNumber, baggageLevel: baggageLevel,
      ),
      'nationality' => PassengerFormData(
        ...
        name: name, mobilePhone: mobilePhone,
        dateOfBirth: dateOfBirth, passportNumber: passportNumber,
        nationality: value as String, address: address,
        email: email, idNumber: idNumber, baggageLevel: baggageLevel,
      ),
      'address' => PassengerFormData(
        ...
        name: name, mobilePhone: mobilePhone,
        dateOfBirth: dateOfBirth, passportNumber: passportNumber,
        nationality: nationality, address: value as String,
        email: email, idNumber: idNumber, baggageLevel: baggageLevel,
      ),
      'email' => PassengerFormData(
        ...
        dateOfBirth: dateOfBirth, passportNumber: passportNumber,
        nationality: nationality, address: address,
        email: value as String, idNumber: idNumber, baggageLevel: baggageLevel,
      ),
      'idNumber' => PassengerFormData(
        ...
        dateOfBirth: dateOfBirth, passportNumber: passportNumber,
        nationality: nationality, address: address,
        email: email, idNumber: value as String, baggageLevel: baggageLevel,
      ),
      'baggageLevel' => PassengerFormData(
        ...
        dateOfBirth: dateOfBirth, passportNumber: passportNumber,
        nationality: nationality, address: address,
        email: email, idNumber: idNumber, baggageLevel: value as String,
      ),
      _ => this,
    };
  }
